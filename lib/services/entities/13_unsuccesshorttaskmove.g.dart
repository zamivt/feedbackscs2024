...
part of '13_unsuccesshorttaskmove.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class UnSuccesShortTaskMoveAdapter extends TypeAdapter<UnSuccesShortTaskMove> {
  @override
  final int typeId = 13;

  @override
  UnSuccesShortTaskMove read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return UnSuccesShortTaskMove(
  ...
  @override
  void write(BinaryWriter writer, UnSuccesShortTaskMove obj) {
    writer
      ..writeByte(21)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is UnSuccesShortTaskMoveAdapter &&
