...
part of '4_short_task_lie.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ShortTaskLieAdapter extends TypeAdapter<ShortTaskLie> {
  @override
  final int typeId = 4;

  @override
  ShortTaskLie read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, ShortTaskLie obj) {
    writer
      ..writeByte(13)
      ..writeByte(0)
      ..write(obj.program)
