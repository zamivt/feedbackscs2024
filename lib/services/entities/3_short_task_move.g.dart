...
part of '3_short_task_move.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ShortTaskMoveAdapter extends TypeAdapter<ShortTaskMove> {
  @override
  final int typeId = 3;

  @override
  ShortTaskMove read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return ShortTaskMove(
  ...
  @override
  void write(BinaryWriter writer, ShortTaskMove obj) {
    writer
      ..writeByte(13)
      ..writeByte(0)
      ..write(obj.program)
