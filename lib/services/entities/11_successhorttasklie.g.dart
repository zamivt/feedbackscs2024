...
part of '11_successhorttasklie.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class SuccesShortTaskLieAdapter extends TypeAdapter<SuccesShortTaskLie> {
  @override
  final int typeId = 11;

  @override
  SuccesShortTaskLie read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return SuccesShortTaskLie(
  ...
  @override
  void write(BinaryWriter writer, SuccesShortTaskLie obj) {
    writer
      ..writeByte(20)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is SuccesShortTaskLieAdapter &&
