...
part of '22_longtaskseat.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class LongTaskSeatAdapter extends TypeAdapter<LongTaskSeat> {
  @override
  final int typeId = 22;

  @override
  LongTaskSeat read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, LongTaskSeat obj) {
    writer
      ..writeByte(15)
      ..writeByte(0)
      ..write(obj.program)
