...
part of '12_successhorttaskseat.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class SuccesShortTaskSeatAdapter extends TypeAdapter<SuccesShortTaskSeat> {
  @override
  final int typeId = 12;

  @override
  SuccesShortTaskSeat read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return SuccesShortTaskSeat(
  ...
  @override
  void write(BinaryWriter writer, SuccesShortTaskSeat obj) {
    writer
      ..writeByte(20)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is SuccesShortTaskSeatAdapter &&
