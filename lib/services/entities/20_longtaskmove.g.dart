...
part of '20_longtaskmove.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class LongTaskMoveAdapter extends TypeAdapter<LongTaskMove> {
  @override
  final int typeId = 20;

  @override
  LongTaskMove read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, LongTaskMove obj) {
    writer
      ..writeByte(15)
      ..writeByte(0)
      ..write(obj.program)
