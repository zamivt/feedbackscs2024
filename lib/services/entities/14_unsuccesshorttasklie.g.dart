...
part of '14_unsuccesshorttasklie.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class UnSuccesShortTaskLieAdapter extends TypeAdapter<UnSuccesShortTaskLie> {
  @override
  final int typeId = 14;

  @override
  UnSuccesShortTaskLie read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return UnSuccesShortTaskLie(
  ...
  @override
  void write(BinaryWriter writer, UnSuccesShortTaskLie obj) {
    writer
      ..writeByte(21)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is UnSuccesShortTaskLieAdapter &&
