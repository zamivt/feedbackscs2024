                  ...
                  children: [
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                    fontSize: 16,
                                    color:
                                        !_ismale ? Colors.grey : Colors.blue),
                              ),
                            ],
                          ),
                        ),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          labelStyle: const TextStyle(fontSize: 16),
                          labelText:
                              LocaleKeys.currentpainlevel.tr() + ' : 1-10',
                          border: UnderlineInputBorder(
                              borderRadius: BorderRadius.circular(8.0)),
                          fillColor: Colors.white,
                          filled: true),
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              style: TextStyle(
                                  fontSize: 16,
                                  color:
                                      _issumcrit ? Colors.blue : Colors.grey),
              ...
              ElevatedButton(
                  onPressed: () {
                    ...
                    if (_formkey.currentState != null &&
                      ...
                      patientController.profPatient(Patient(
                        ...
                        diagnoz: _diagnozCtrl.text,
                        anamnez: _anamnezCtrl.text,
                        levelmaxpain: int.parse(_levelmaxpainCtrl.text),
                        sympotoms1: _symptoms1Ctrl.text,
                        sympotoms2: _symptoms2Ctrl.text,
                        sympotoms3: _symptoms3Ctrl.text,
                        modelneuro: _modelneuro.toString(),
                        priorityshorttest:
                            _issumcrit ? choicesol[0] : choicesol[1],
                        prioritylevelpain:
                            int.parse(_levelmaxpainCtrl.text) ~/ 2,
                        timelie: int.parse(_maxlieCtrl.text),
                        timeseat: int.parse(_maxseatCtrl.text),
                        timemove: int.parse(_maxmoveCtrl.text),
                        teststage: LocaleKeys.shortlongtest.tr(),
                      ));
