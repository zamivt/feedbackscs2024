                                                                        ...
                                                                        for (int i =
                                                                          ...
                                                                          TableRow(
                                                                            children: [
                                                                              ...
                                                                              Text(
                                                                                _doubleshorttaskController.doubleshorttask[i].condition != LocaleKeys.fixamp.tr() ? _doubleshorttaskController.doubleshorttask[i].condition.toString() : _doubleshorttaskController.doubleshorttask[i].amplit.toString(),
                                                                                textAlign: TextAlign.center,
                                                                                maxLines: 1,
                                                                              ),
                                                                              Text(
